...
def upload_image(contents, project_id: str):
    """
    This function extracts the relevant images from the PDF file and stores them in the database.
    """
    try:
        # Open the document
        ...
        for image in images:
            ...
            # If image is relevant then store it in the database
...
def get_image_name(base64_image, project_id: str):
    ...
    try:
        ...
        # Use OpenAI's Chat API directly
